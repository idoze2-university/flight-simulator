...
GENERIC_SMALL_PATH = "test/generic_small.xml"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--generic-small',
                        default=GENERIC_SMALL_PATH, type=str)
